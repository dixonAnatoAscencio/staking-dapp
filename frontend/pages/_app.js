...
import 'sf-font';
import { getPoolDetails, connectWallet } from '../components/config';
...
function MyApp({ Component, pageProps }) {
  ...
  async function connect() {
    ...
    localStorage.setItem('wallet', walletaddress);//guardamos temporalmente la dirección de la wallet en el navegador
  }
